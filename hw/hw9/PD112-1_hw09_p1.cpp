...
Product::Product(const Product& other) {
    ...
    overallCost = other.overallCost;
    currentItemIdx = other.currentItemIdx;
...
bool Product::operator<(const Product& other) const {
    int profitThis = this->salesQty*(this->price - this->overallCost);
    int profitOther = other.salesQty*(other.price - other.overallCost);
    return profitThis < profitOther;
}
