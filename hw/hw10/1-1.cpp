...
public:
    Zoo();
    ~Zoo();
    bool isFull() const {return this->displayAnimalCnt + this->showAnimalCnt == ZOO_CAP;};
...
void Zoo::print() const {
    cout << this->displayAnimalCnt << endl;
}
